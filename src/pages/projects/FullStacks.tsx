        ...
        <Box className="text-wrapper fade-in">
            ...
            <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, gap: 3, mb: 4 }}>
                <Paper className="bounce" elevation={3} sx={{ flex: 2, p: 4, borderRadius: 3 }}>
                    ...
                    <Typography variant="body1" component="p" sx={{ mb: 2 }}>
                        This project is exciting because it's my first where I have written absolutely <i>everything</i> from scratch, including my own API specifications in compliance with <b>OpenAPI</b>'s standards. The current API spec can be found here <i>[link forthcoming]</i> — view using <b>Swagger</b> or a similar editor. I will have a native setup to view this in due time, but my current focus is on the app itself!
                    </Typography>
                    <Typography variant="body1" component="p" sx={{ mb: 2 }}>
